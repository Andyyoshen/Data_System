        ...
        <form >
          <div class="form-group input-group">
            <div class="input-group   mb-3">
              ...
              <input
                type="text"
                :class=" ACUSERNAME_COLOR == 'blue' ? 'form-control':'form-control is-invalid'"
                placeholder="用戶名"
                aria-label="Username"
                aria-describedby="basic-addon1"
                v-model="ACCOUNT_Data.AC_USERNAME"
              />
              <small  v-if="ACUSERNAME_COLOR == 'red'" class="w-100 text-danger" style="font-size:10px" >已有相同用戶名</small>
            </div>
        ...
        <input name="" class="form-control" placeholder="Full name" type="text"> -->
          ...
          <div class="form-group input-group">
            <div class="input-group mb-3">
              ...
              <input
                type="text"
                :class=" ACUSER_COLOR == 'blue' ? 'form-control':'form-control is-invalid'"
                placeholder="帳號"
                aria-label="Username"
                aria-describedby="basic-addon1"
                v-model="ACCOUNT_Data.AC_USER"
              />
                <small  v-if="ACUSER_COLOR == 'red'" class="w-100 text-danger" style="font-size:10px" >已有相同帳號</small>
            </div>
          </div>
          <!-- form-group// -->
          <div class="form-group input-group">
            <div class="input-group mb-3">
              ...
              <input
                type="text"
                :class=" ACEMAIL_COLOR == 'blue' ? 'form-control':'form-control is-invalid'"
                placeholder="信箱"
                aria-label="Username"
                aria-describedby="basic-addon1"
                v-model="ACCOUNT_Data.AC_EMAIL"
              />
                <small  v-if="ACEMAIL_COLOR == 'red'" class="w-100 text-danger" style="font-size:10px" >已有相同信箱</small>
            </div>
          </div>
          ...
          <div class="form-group input-group">
            <div class="input-group mb-3">
              ...
              <input
                type="text"
                :class=" ACPWDCHECK_COLOR == 'blue' ? 'form-control':'form-control is-invalid'"
                placeholder="確認密碼"
                aria-label="Username"
                aria-describedby="basic-addon1"
                v-model="AC_PWDCHECK"
              />
              <small  v-if="ACPWDCHECK_COLOR == 'red'" class="w-100 text-danger" style="font-size:10px" >密碼不相同</small>
            </div>
          </div>
          <!-- form-group// -->
          <div class="form-group mb-3">
            <button
              type="submit"
              :class="this.registerButtonCheck == false ?  'w-100 btn btn-primary btn-block disabled': 'w-100 btn btn-primary btn-block' "
              @click="register()"
            >
              Create Account
            </button>
...
export default {
  ...
  watch:{
    $data:{
      handler:function(nval,oval){  // 觀看data裡的值是否符合條件(控制註冊按鈕)
        ...
        if( oval.ACCOUNT_Data.AC_USERNAME != ""  &&
